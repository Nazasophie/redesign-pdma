/*! bdtUIkit 3.16.24 | https://www.getuikit.com | (c) 2014 - 2023 YOOtheme | MIT License */
(function(be, $e) {
    typeof exports == "object" && typeof module < "u" ? module.exports = $e() : typeof define == "function" && define.amd ? define("uikit", $e) : (be = typeof globalThis < "u" ? globalThis : be || self, be.bdtUIkit = $e())
})(this, function() {
    "use strict";
    const {
        hasOwnProperty: be,
    ...
    const Fo = /\B([A-Z])/g,
        ...
        Ho = /-(\w)/g,
        xe = dt(t => (t.charAt(0).toLowerCase() + t.slice(1)).replace(Ho, (e, i) => i.toUpperCase())),
    ...
    function tr(t, e, i = 400, s = "linear") {
        return i = Math.round(i), Promise.all(k(t).map(n => new Promise((o, r) => {
            ...
            j(n, "transitionend transitioncanceled", ({
                type: l
            }) => {
                clearTimeout(a), M(n, "bdt-transition"), c(n, {
                    transitionProperty: "",
                    transitionDuration: "",
    ...
    function zs(t, e, i = 200, s, n) {
        return Promise.all(k(t).map(o => new Promise((r, a) => {
            ...
            j(o, "animationend animationcanceled", ({
                type: h
            }) => {
                clearTimeout(l), h === "animationcanceled" ? a() : r(o), c(o, "animationDuration", ""), Vi(o, `${Pe}\\S*`)
            }, {
                self: !0
            }), c(o, "animationDuration", `${i}ms`), y(o, e, Pe + (n ? "leave" : "enter")), ot(e, Pe) && (s && y(o, `bdt-transform-origin-${s}`), n && y(o, `${Pe}reverse`))
        })))
    }
    ...
    function Ht(t) {
        ...
        for (; t = t.offsetParent;)
            if (e[0] += t.offsetTop + x(c(t, "borderTopWidth")), e[1] += t.offsetLeft + x(c(t, "borderLeftWidth")), c(t, "position") === "fixed") {
                const i = ne(t);
    ...
    function Be(t, e, i) {
        const s = {};
        if (it(e) && (e = e.options), e.extends && (t = Be(t, e.extends, i)), e.mixins)
    ...
    function Hr(t) {
        return Q(t) ? t : D(t) ? t.split(/,(?![^(]*\))/).map(e => bt(e) ? kt(e) : Bi(e.trim())) : [t]
    }
        ...
        const r = Object.keys(n),
            ...
            l = new MutationObserver(h => {
                ...
                h.some(({
                    ...
                    return (d === s ? r : [xe(d), xe(f)]).some(g => !Y(u[g]) && u[g] !== i[g])
                }) && t.$reset()
            });
        l.observe(o, {
            attributes: !0,
    ...
    async function sa(t, e, {
        ...
        const [l = "reveal", h = "top"] = ((a = i[0]) == null ? void 0 : a.split("-")) || [], u = [
            ["left", "right"],
            ["top", "bottom"]
        ], f = u[m(u[0], h) ? 0 : 1], d = f[1] === h, A = ["width", "height"][u.indexOf(f)], N = `margin-${f[0]}`, F = `margin-${h}`;
        let Ot = b(t)[A];
    ...
    var _n = {
        ...
        methods: {
            ...
            getPositionOffset(t) {
                return ht(this.offset === !1 ? c(t, "--bdt-position-offset") : this.offset, this.axis === "x" ? "width" : "height", t) * (m(["left", "top"], this.dir) ? -1 : 1) * (this.inset ? -1 : 1)
            },
            getShiftOffset(t) {
                return this.align === "center" ? 0 : ht(c(t, "--bdt-position-shift-offset"), this.axis === "y" ? "width" : "height", t) * (m(["left", "top"], this.align) ? 1 : -1)
            },
            getViewportOffset(t) {
    ...
    var On = {
        ...
        connected() {
            y(this.$el, "bdt-drop", this.clsDrop), this.toggle && !this.targetEl && (this.targetEl = pa(this)), this._style = Ni(this.$el.style, ["width", "height"])
        },
        disconnected() {
        ...
        methods: {
            ...
            position() {
                M(this.$el, "bdt-drop-stack"), c(this.$el, this._style), this.$el.hidden = !0;
                ...
                this.$el.hidden = !1, c(this.$el, "maxWidth", ""), this.$el.offsetWidth > s && y(this.$el, "bdt-drop-stack"), c(this.$el, "maxWidth", s), this.positionAt(this.$el, this.target, this.boundary);
    ...
    function wa(t) {
        return $(document, mt, ({
            ...
            B(e, t.$el) || j(document, `${Pt} ${li} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
        ...
        events: [{
            ...
            handler({
                ...
                const e = this.getDropdown(t),
                    i = () => {
                        const s = re(t, `.${this.clsDrop}`).concat(t).map(a => _(a)),
                            n = Math.min(...s.map(({
                                top: a
                            }) => a)),
                            o = Math.max(...s.map(({
    ...
    const bi = {
        ...
        Ka = {
            ...
            beforeConnect() {
                if (this.icon = P(this.$el, "bdt-search-icon") && re(this.$el, ".bdt-search-large").length ? "search-large" : re(this.$el, ".bdt-search-navbar").length ? "search-navbar" : this.$props.icon, !$t(this.$el, "aria-label"))
                    if (P(this.$el, "bdt-search-toggle") || P(this.$el, "bdt-navbar-toggle")) {
        ...
        tl = {
            ...
            beforeConnect() {
                this.icon = `close-${P(this.$el,"bdt-close-large")?"large":"icon"}`
            }
        },
        el = {
            extends: Gt,
    ...
    function bl(t) {
        return $(document, mt, ({
            ...
            oe(nt) !== t || t.overlay && !B(e, t.$el) || B(e, t.panel) || j(document, `${Pt} ${li} scroll`, ({
                defaultPrevented: i,
                type: s,
                target: n
            }) => {
    ...
    var xl = {
        ...
        events: [{
            ...
            self: !0,
            handler() {
                P(this.panel, "bdt-margin-auto-vertical") ? y(this.$el, "bdt-flex") : c(this.$el, "display", "block"), et(this.$el)
            }
        }, {
            name: "hidden",
            self: !0,
    ...
    function yl({
        ...
        t.dialog = function(i, s) {
            ...
            return e(({
                i18n: n
            }) => `<div class="bdt-modal-body">${D(i)?i:Nt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-primary bdt-modal-close" autofocus>${n.ok}</button> </div>`, s)
        }, t.confirm = function(i, s) {
            return e(({
                i18n: n
            }) => `<form> <div class="bdt-modal-body">${D(i)?i:Nt(i)}</div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${n.cancel}</button> <button class="bdt-button bdt-button-primary" autofocus>${n.ok}</button> </div> </form>`, s, () => Promise.reject())
        }, t.prompt = function(i, s, n) {
            const o = e(({
                    i18n: l
                }) => `<form class="bdt-form-stacked"> <div class="bdt-modal-body"> <label>${D(i)?i:Nt(i)}</label> <input class="bdt-input" value="${s||""}" autofocus> </div> <div class="bdt-modal-footer bdt-text-right"> <button class="bdt-button bdt-button-default bdt-modal-close" type="button">${l.cancel}</button> <button class="bdt-button bdt-button-primary">${l.ok}</button> </div> </form>`, n, () => null, () => a.value),
                {
                    $el: r
                } = o.dialog,
                a = w("input", r);
    ...
    function qn(t) {
        if (!t.defaultPrevented)
            for (const e of We) B(t.target, e.$el) && le(e.$el) && (t.preventDefault(), window.location.href !== e.$el.href && window.history.pushState({}, "", e.$el.href), e.scrollTo(Wi(e.$el)))
    }
    var Dl = {
            args: "cls",
            props: {
            ...
            methods: {
                toggle(t, e) {
                    ...
                    if (s) {
                        if ((i = s.off) == null || i.call(s), c(t, "opacity", !e && this.hidden ? 0 : ""), q(t, this.inViewClass, e), q(t, s.cls), /\bbdt-animation-/.test(s.cls)) {
        ...
        Ml = {
            ...
            connected() {
                this.start = Un(this.start || this.top), this.end = Un(this.end || this.bottom), this.placeholder = w("+ .bdt-sticky-placeholder", this.$el) || w('<div class="bdt-sticky-placeholder"></div>'), this.isFixed = !1, this.setActive(!1)
            },
            beforeDisconnect() {
    ...
    var Kn = {
        ...
        Wl = {
            ...
            connected() {
                const t = P(this.$el, "bdt-tab-left") ? "bdt-tab-left" : P(this.$el, "bdt-tab-right") ? "bdt-tab-right" : !1;
        ...
        methods: {
            updateNav() {
                ...
                for (const s of this.navItems) {
                    ...
                    } else q(s, "bdt-invisible", this.finite && (n === "previous" && t === 0 || n === "next" && t >= this.maxIndex));
                    e && i && i.focus()
                }
            }
        }
    ...
    var fo = {
        ...
        po = {
            ...
            methods: {
                ...
                showControls() {
                    clearTimeout(this.controlsTimer), this.controlsTimer = setTimeout(this.hideControls, this.delayControls), y(this.$el, "bdt-active", "bdt-transition-active")
                },
                hideControls() {
    ...
    var gh = {
        ...
        created() {
            ...
            (!e || !R(e)) && (e = L(this.container, `<div class="${this.clsContainer} ${t}"></div>`)), this.$mount(L(e, `<div class="${this.clsMsg}${this.status?` ${this.clsMsg}-${this.status}`:""}" role="alert"> <a href class="${this.clsClose}" data-bdt-close></a> <div>${this.message}</div> </div>`))
        },
        async connected() {
    ...
    function Ci(t, e, i) {
        let s = Ei(i) || {
            ...
            n;
        return t === "x" || t === "y" ? (t = `translate${Ct(t)}`, n = o => x(x(o).toFixed(s === "px" ? 0 : 6))) : t === "scale" && (s = "", n = o => Ei([o]) ? ht(o, "width", e, !0) / e.offsetWidth : o), i.length === 1 && i.unshift(t === "scale" ? 1 : 0), i = we(i, n), (o, r) => {
    ...
    function we(t, e = x) {
        ...
        for (let o = 0; o < s; o++) {
            ...
            if (r = e(r), a = a ? x(a) / 100 : null, o === 0 ? a === null ? a = 0 : a && i.push([r, 0]) : o === s - 1 && (a === null ? a = 1 : a !== 1 && (i.push([r, a]), a = 1)), i.push([r, a]), a === null) n++;
            else if (n) {
                const l = i[o - n - 1][1],
                    h = (a - l) / (n + 1);
            ...
            translate(h) {
                ...
                for (const A of T(o)) {
                    const N = m(f, A),
                        F = A === d,
                        Ot = A === g,
                        Es = F || !Ot && (N || i * (X ? -1 : 1) === -1 ^ _i(A, o) > _i(t || e));
        ...
        methods: {
            ...
            updateActiveClasses() {
                const t = this._getTransitioner(this.index).getActives(),
                    e = [this.clsActive, (!this.sets || m(this.sets, x(this.index))) && this.clsActivated || ""];
        ...
        Oh = {
            ...
            methods: {
                init(t) {
                    ...
                    !n || s || i > 0 || Li(e) || B(e, `.${this.clsNoDrag}`) || this.handle && !B(e, this.handle) || (t.preventDefault(), this.touched = new Set([this]), this.placeholder = n, this.origin = {
                        target: e,
                        index: ae(n),
                        ...this.pos
                ...
                move(t) {
                    ...
                    this === t ? this.origin.index !== ae(this.placeholder) && v(this.$el, "moved", [this, this.placeholder]) : (v(t.$el, "added", [t, this.placeholder]), v(this.$el, "removed", [this, this.placeholder])), v(this.$el, "stop", [this, this.placeholder]), lt(this.drag), this.drag = null;
                    for (const {
                            clsPlaceholder: e,
                            clsItem: i
                        } of this.touched)
    ...
    var Hh = {
        ...
        methods: {
            ...
            async _show() {
                this.tooltip = L(this.container, `<div id="${this.id}" class="bdt-${this.$options.name}" role="tooltip"> <div class="bdt-${this.$options.name}-inner">${this.title}</div> </div>`), $(this.tooltip, "toggled", (t, e) => {
                    if (!e) return;
                    ...
                    const o = [j(document, `keydown ${mt}`, this.hide, !1, r => r.type === mt && !B(r.target, this.$el) || r.type === "keydown" && r.keyCode === I.ESC), $([document, ...jt(this.$el)], "scroll", i, {
                        passive: !0
                    })];

(() => {
    ...
    function n(t, r, n) {
        ...
        }(r, "string"), (r = "symbol" == e(i) ? i : String(i)) in t ? Object.defineProperty(t, r, {
            value: n,
            enumerable: !0,
            configurable: !0,
            writable: !0
        ...
        window.fluentFormrecaptchaSuccessCallback = function(e) {
            ...
            function(e, t) {
                ...
                window.fluentFormApp = function(r) {
                    ...
                    if (n[i]) return n[i];
                    var s, f, l, c, u, d, m, p, h, v, g, _, y, b, w, k, C, x, S, j, O, F, T, A, N = o.form_id_selector,
                        Q = "." + i;
                    return s = a, f = {}, l = function() {
                        return t("body").find("form" + Q)
                    }, u = function(e, t) {
                        ...
                        try {
                            ...
                            r.each((function() {
                                ...
                                i.includes(r) || (t(this).is(":checkbox") || t(this).is(":radio")) && (a[r] || e.find('input[name="' + r + '"]:checked').length || (n.push({
                                    name: r,
                                    value: ""
                                }), a[r] = !0))
                            }));
                            ...
                            if (t.each(e.find("[type=file]"), (function(e, r) {
                                    var n = {},
                                        i = r.name + "[]";
                                    n[i] = [], t(r).closest("div").find(".ff-uploaded-list").find(".ff-upload-preview[data-src]").each((function(e, r) {
                                        n[i][e] = t(this).data("src")
                                ...
                                return t(Q + "_errors").html(s.append(c, l)).show()
                            }
                            ...
                            if (e.find(".ff-el-turnstile.cf-turnstile").length) {
                                var h = y(o.form_id);
                                h && (o.data += "&" + t.param({
                                    "cf-turnstile-response": h.getResponse(h)
                                }))
                            }
                            t(Q + "_success").remove(), t(Q + "_errors").html(""), e.find(".error").html(""), e.parent().find(".ff-errors-in-stack").hide(),
                                function(e, t) {
                                    var r = [],
                                        n = f;
                        ...
                        if (!this.isSending) {
                            ...
                            this.isSending = !0, t.post(s, n).then((function(n) {
                                ...
                                if (n.data.append_data && T(n.data.append_data), n.data.nextAction) r.trigger("fluentform_next_action_" + n.data.nextAction, {
                                    form: r,
                                    response: n
                                });
                                else {
                                ...
                                if (r.trigger("fluentform_submission_failed", {
                                    ...
                                    if (t.responseJSON.append_data && T(t.responseJSON.append_data), x(t.responseJSON.errors), w(350), r.find(".fluentform-step").length) {
                        ...
                        var r = l().parent().find(".ff-errors-in-stack");
                        ...
                        var n, i;
                        (n = F(e)).length ? (n.attr("aria-invalid", "true"), (i = t("<div/>", {
                            class: "error text-danger"
                        })).attr("role", "alert"), n.closest(".ff-el-group").addClass("ff-el-is-error"), n.closest(".ff-el-input--content").length ? (n.closest(".ff-el-input--content").find("div.error").remove(), n.closest(".ff-el-input--content").append(i.html(r))) : (n.find("div.error").remove(), n.append(i.text(r)))) : S([r])
                    }, O = function() {
                        ...
                        initFormHandlers: function() {
                            v(), c(), O(), r.removeClass("ff-form-loading").addClass("ff-form-loaded"), r.on("show_element_error", (function(e, t) {
                        ...
                        initTriggers: function() {
                            r = l(), jQuery(document.body).trigger("fluentform_init", [r, o]), jQuery(document.body).trigger("fluentform_init_" + o.id, [r, o]), r.trigger("fluentform_init_single", [this, o]), r.find("input.ff-el-form-control").on("keypress", (function(e) {
                                ...
                                var o = t(this).offset().left,
                                    ...
                                    f = i.outerHeight(),
                                    l = o - s / 2 + 10;
                                l < 15 && (l = 15), i.css("top", t(this).offset().top - f - 5), i.css("left", l)
                            ...
                            if (null != jQuery.fn.mask) {
                                ...
                                jQuery("input[data-mask]").each((function(t, r) {
                                    var n = (r = jQuery(r)).attr("data-mask"),
                                        i = e;
                                    r.attr("data-mask-reverse") && (i.reverse = !0), r.attr("data-clear-if-not-match") && (i.clearIfNotMatch = !0), n && r.mask(n, i)
                                }))
                            }
                        },

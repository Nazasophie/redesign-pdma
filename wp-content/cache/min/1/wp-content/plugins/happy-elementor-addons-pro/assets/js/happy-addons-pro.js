...
(function($, Happy, w) {
    ...
    $window.on('elementor/frontend/init', function() {
        ...
        var DataTable = function($scope) {
            ...
            const search = dataTable.data('search') == !0 ? !0 : !1;
            const paging = dataTable.data('paging') == !0 ? !0 : !1;
        ...
        $(document.body).on('adding_to_cart', function(event, $addToCart) {
            $addToCart.parent('.ha-product-grid__btns').removeClass('ha-is--added').addClass('ha-is--adding')
        });

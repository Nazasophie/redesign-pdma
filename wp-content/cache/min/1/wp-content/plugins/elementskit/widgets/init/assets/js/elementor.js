! function(e, t) {
    ...
    var i = {
        ...
        WidgetAreaJSUpdate: function() {
            var t = e(this),
                i = ["ekit-nav-menu", "ekit-vertical-menu", "gallery"],
                n = 0;
        ...
        Social_Review_Slider: function(i) {
            i.each((function() {
                let i = `\n\t\t\t\t\t<button type="button" class="slick-prev slick-arrow">\n\t\t\t\t\t\t<i class="${e(this).data("prevarrow")?e(this).data("prevarrow"):"icon icon-left-arrow2"}"></i>\n\t\t\t\t\t</button>\n\t\t\t\t`,
                    ...
                    a = !(!e(this).data("autoplay") || "yes" !== e(this).data("autoplay")),
                    s = {
                        autoplay: a,
                        slidesPerView: "undefined" !== e(this).data("slidestoshow") ? e(this).data("slidestoshow") : 1,
                        slidesPerGroup: "undefined" !== e(this).data("slidestoscroll") ? e(this).data("slidestoscroll") : 1,
                        speed: "undefined" !== e(this).data("speed") ? e(this).data("speed") : 1e3,
                        arrows: "yes" === e(this).data("showarrow"),
                        dots: "yes" === e(this).data("showdot"),
                        pauseOnHover: "yes" == e(this).data("pauseonhover"),
                        infinite: "undefined" === e(this).data("autoplay") || a,
                        breakpoints: "[]" !== e(this).data("responsive") ? e(this).data("responsive") : [],
                        loop: "yes" == e(this).data("carousel_loop")
                    };
                s.arrows && (e(this).append(i + n), s.navigation = {
                    prevEl: e(this).find(".slick-prev").get(0),
                    nextEl: e(this).find(".slick-next").get(0)
                }), s.dots && (s.pagination = {
                    el: e(this).find(".swiper-pagination").get(0),
                    type: "custom",
                    clickable: !0,
                    renderCustom: (e, t, i) => {
                        var n = "";
                        for (let e = 1; e <= i; e++) n += '<li role="presentation" class="' + (t === e ? " swiper-pagination-bullet-active slick-active" : "swiper-pagination-bullet") + '"><button type="button" role="tab"  tabindex="0" aria-selected="true" class="">' + e + "</button></li>";
                        return n
                    }
                });
                let o = $scope.find(`.${t.config.swiperClass}`);
                ElementsKit_Helper.swiper(o, s).then((function(e) {})), a && s.pauseOnHover && e(this).find(".swiper-container").hover((function() {
        ...
        Advanced_Tab: function(t) {
            var n = t.find('[data-ekit-toggle="tab"]'),
                a = n.data("ekit-toggle-trigger"),
                s = t.data("settings");
            ElementsKit_Helper.triggerClickOnEvent(a, n), n.on("shown.bs.tab", (function() {
                let a = t.find(e(this)).data("target").substring(1),
                    o = t.find(`#${a}`);
                i.WidgetAreaJSUpdate.call(o), 1 == s.ekit_hash_change && n.click("shown.bs.tab", (function() {
                    ElementsKit_Helper.setURLHash(s, this, "ekit-handler-id")
                })), ElementsKit_Helper.ajaxLoading(t, o)
            })).filter(".active").trigger("shown.bs.tab")
        },
        Gallery: function(t) {
        ...
        Video_Gallery: function(i) {
            ...
            if (n.length > 0 && n.magnificPopup({
                ...
                l.arrows && (l.navigation = {
                    prevEl: i.find(".slick-prev").get(0),
                    nextEl: i.find(".slick-next").get(0)
                }), l.dots && (l.pagination = {
                ...
                ElementsKit_Helper.swiper(e, l).then((function(t) {
                    l.autoplay && l.pauseOnHover && e.hover((function() {
                        t.autoplay.stop()
                    }), (function() {
                        t.autoplay.start()
                    }))
        ...
        BlogPosts: function(i) {
            ...
            if (i.on("click", ".ekit-blog-post-pagination-container a.page-numbers", (function(t) {
                    ...
                    e.ajax({
                        ...
                        "loadmore" == n.data("ekit-blog-post-style") ? i.find(s.items).append(o) : i.find(s.items).html(o), i.find(s.nagivation).html(l)
                    }))
        ...
        Advanced_Slider: function(i) {
            ...
            ElementsKit_Helper.swiper(r, l).then((function(e) {})), "yes" == o.sliderOptions.progressBar && (i.find(".ekit-slider-wrapper, .ekit-swiper-progress").each((function(t, i) {
                ...
                let {
                    sliderOptions: t
                } = o, i = n.find(".swiper-pagination.ekit-swiper-pagination"), a = i.children(".swiper-pagination-bullet"), s = t.sliderTabItems.map((e => e.ekit_slider_thumbs_image.url)), l = a.length, r = {
                    display: "grid"
                };
                a.each((function(t) {
                    const i = e(this);
                ...
                })), "horizontal" === t.sliderDirectionType ? (r.width = t.sliderThumbsOffset.size ? `${t.sliderThumbsOffset.size}%` : "70%", r.gridTemplateColumns = `repeat(${l}, 1fr)`, r.gridTemplateRows = "1fr", r.marginTop = "7px") : (r.gridTemplateColumns = "1fr", r.gridTemplateRows = `repeat(${l}, 1fr)`), i.css(r), n.addClass("slider-thumbs-yes")
            }()
        },
        Whatsapp: function(e) {
            ...
            if ("animated" === i.animationStyle) {
                ...
                function u(e) {
                    ...
                    if (e.parents(".ekit-fancy-text").hasClass("type")) {
                        ...
                        _(e, t), m(e.find("i").eq(0), e, p, o), k(t.find("i").eq(0), t, p, o)

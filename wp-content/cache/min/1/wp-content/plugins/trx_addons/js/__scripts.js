(function() {
    ...
    window.trx_addons_copy_to_clipboard = function(str, strip_tags) {
        var selected = document.getSelection().rangeCount > 0 ? document.getSelection().getRangeAt(0) : !1;
    ...
    window.trx_addons_form_validate = function(form, opt) {
        if (typeof(opt.error_message_show) == 'undefined') opt.error_message_show = !0;
        if (typeof(opt.error_message_time) == 'undefined') opt.error_message_time = 5000;
        if (typeof(opt.error_message_class) == 'undefined') opt.error_message_class = 'trx_addons_message_box_error';
        if (typeof(opt.success_message_class) == 'undefined') opt.success_message_class = 'trx_addons_message_box_success';
        if (typeof(opt.error_message_text) == 'undefined') opt.error_message_text = 'Incorrect data in the fields!';
        if (typeof(opt.error_fields_class) == 'undefined') opt.error_fields_class = 'trx_addons_field_error';
        if (typeof(opt.exit_after_first_error) == 'undefined') opt.exit_after_first_error = !1;
        var error_msg = '';
    ...
    window.trx_addons_refresh_list = function(parent_type, parent_val, list_fld, list_lbl, list_not_selected) {
        if (list_not_selected === undefined) {
            list_not_selected = list_fld.data('not-selected') === !0 || list_fld.parents('.vc_edit-form-tab').length > 0 || list_fld.parents('#elementor-controls').length > 0 || list_fld.parents('[class*="widget_field_type_"]').length > 0 || list_fld.parents('.widget-liquid-right').length > 0 || list_fld.parents('.widgets-holder-wrap').length > 0 || list_fld.parents('.customize-control-widget_form').length > 0
        }
        ...
        function trx_addons_refresh_field_items(data) {
            ...
            if (list_type == 'select' && list_fld.find('option:selected').length === 0 && list_fld.find('option').length > 0) {
                list_fld.find('option').get(0).selected = !0
            }
    ...
    window.trx_addons_document_animate_to = function(id, callback) {
        ...
        window.trx_addons_document_animate_to_busy = !0;
        if (oft2 >= 0) {
            setTimeout(function() {
    ...
    window.trx_addons_browser_is_ios = function() {
        return navigator.userAgent.match(/iPad|iPhone|iPod/i) !== null ? !0 : !1
    };
    window.trx_addons_browser_is_iphone = function() {
        return navigator.userAgent.match(/iPhone/i) !== null ? !0 : !1
    };
    window.trx_addons_browser_is_ipad = function() {
        return navigator.userAgent.match(/iPad/i) !== null ? !0 : !1
    };
    window.trx_addons_browser_is_ipod = function() {
        return navigator.userAgent.match(/iPod/i) !== null ? !0 : !1
    };
    ...
    window.trx_addons_browser_classes = function() {
        var userAgent = navigator.userAgent,
            ...
            classes = {
                ...
                'ie': /Trident|MSIE/.test(userAgent) && (!1 || !!document.documentMode),
    ...
    window.trx_addons_is_empty = function(prm) {
        return prm === undefined || prm === '' || prm === 0 || prm === !1 || (typeof prm == 'object' && Object.keys(prm).length === 0)
    };
    ...
    window.trx_addons_serialize = function(mixed_val) {
        ...
        switch (typeof(mixed_val)) {
            case "number":
                if (isNaN(mixed_val) || !isFinite(mixed_val)) return !1;
            ...
            case "object":
                if (mixed_val == null) return "N;";
                    ...
                    if (class_name == undefined) return !1;
                    var props = new Array();
    ...
    var support = {
            transitions: window.Modernizr ? Modernizr.csstransitions : !1,
            animations: window.Modernizr ? Modernizr.cssanimations : !1
        },
    ...
    window.trx_addons_on_end_transition = function(el, callback, timeout) {
        ...
        if (support.transitions) {
            el.addEventListener(trans_end_event_name, on_end_callback, !1)
        } else {
            setTimeout(function() {
                if (callback && typeof callback === 'function') {
                    callback.call(this)
    ...
    window.trx_addons_on_end_animation = function(el, callback, timeout) {
        ...
        if (support.animations) {
            el.addEventListener(anima_end_event_name, on_end_callback, !1)
        } else {
            setTimeout(function() {
                if (callback && typeof callback === 'function') {
                    callback.call(this)
    ...
    jQuery(document).ready(function() {
        ...
        function trx_addons_init_actions() {
            ...
            if (typeof TRX_ADDONS_STORAGE.animate_to_hash == 'undefined' && !$body.hasClass('single-product')) {
                TRX_ADDONS_STORAGE.animate_to_hash = !0;
                setTimeout(function() {
                    var $mc4form = !1;
                ...
                function trx_addons_scroll_start(force) {
                    if (requestAnimationFrame && !force) {
                        if (!TRX_ADDONS_STORAGE.scroll_busy) {
                            TRX_ADDONS_STORAGE.scroll_busy = !0;
        ...
        function trx_addons_ready_actions(e, container) {
            ...
            if (jQuery.ui && jQuery.ui.accordion) {
                ...
                if ($accordion.length > 0) {
                    $accordion.each(function() {
                        ...
                        var collapsible = accordion.data('collapsible') || !1;
            ...
            if ($play_on_hover.length > 0) {
                $play_on_hover.addClass('inited').on('mouseenter touchstart', function(e) {
                    ...
                    if (!$self.hasClass('trx_addons_video_hover_play') && (e.type != 'touchstart' || !touchstart_just_fired)) {
                        ...
                        touchstart_just_fired = !0;
                        setTimeout(function() {
                            touchstart_just_fired = !1
                        }, 300)
                    }
            ...
            if (TRX_ADDONS_STORAGE.popup_engine == 'pretty') {
                ...
                container.find(trx_addons_apply_filters('mfp-init-popup-selector', ".trx_addons_popup_link:not(.popup_inited)")).addClass('popup_inited').magnificPopup(trx_addons_apply_filters('mfp-init-popup-params', {
                    ...
                    callbacks: {
                        ...
                        open: function() {
                            trx_addons_prepare_popup_content(this.content, !0)
                        },
                        beforeClose: function() {
                            var $mfp = this;
                ...
                container.find(trx_addons_apply_filters('init-panel-selector', ".trx_addons_panel_link:not(.panel_inited)")).addClass('panel_inited').on('click', function(e) {
                    ...
                    if (!panel.hasClass('sc_layouts_panel_opened')) {
                        ...
                        trx_addons_prepare_popup_content(panel, !0);
            ...
            if (TRX_ADDONS_STORAGE.ajax_views && !TRX_ADDONS_STORAGE.post_views_counter_inited) {
                TRX_ADDONS_STORAGE.post_views_counter_inited = !0;
        ...
        window.trx_addons_scroll_actions = function() {
            ...
            TRX_ADDONS_STORAGE.scroll_busy = !1
        };
        ...
        function trx_addons_get_scroll_posts() {
            TRX_ADDONS_STORAGE.scroll_posts = (TRX_ADDONS_STORAGE.scroll_posts !== undefined && TRX_ADDONS_STORAGE.scroll_posts.length > 0) || jQuery('.nav-links-single-scroll').length > 0 ? jQuery('.post_item_single') : !1;
        ...
        function trx_addons_stack_section_zoom() {
            $stack_sections.each(function() {
                ...
                if (!TRX_ADDONS_STORAGE.GSAP_Plugin_ScrollTrigger) {
                    TRX_ADDONS_STORAGE.GSAP_Plugin_ScrollTrigger = !0;
...
jQuery(document).on('action.ready_trx_addons', function() {
    ...
    function trx_addons_login_validate(form) {
        ...
        if (TRX_ADDONS_STORAGE.login_via_ajax && !error) {
            trx_addons_login_ajax_loading(form, !0);
            jQuery.post(TRX_ADDONS_STORAGE.ajax_url, {
                ...
                trx_addons_login_ajax_loading(form, !1);
                var rez = {};
                try {
                    rez = JSON.parse(response)
                } catch (e) {
            ...
            jQuery.post(TRX_ADDONS_STORAGE.ajax_url, {
                ...
                if (rez.error === '') {
                    ...
                    if (!TRX_ADDONS_STORAGE.double_opt_in_registration) {
                        setTimeout(function() {
                            if (rez.redirect_to !== '' && trx_addons_apply_filters('trx_addons_filter_redirect_after_user_registration', !1, rez.redirect_to)) {
...
jQuery(document).ready(function() {
    ...
    update_jquery_links();
    if (typeof TRX_ADDONS_STORAGE != 'undefined') {
        TRX_ADDONS_STORAGE.pagination_busy = !1
    }
    $document.on('action.init_hidden_elements', function() {
        ...
        jQuery('.sc_item_filters:not(.inited),.sc_item_pagination:not(.inited)').addClass('inited').each(function() {
            ...
            if (!link.hasClass('active') && !TRX_ADDONS_STORAGE.pagination_busy) {
                var link_wrap = link.parents('.sc_item_filters,.sc_item_pagination'),
                    ...
                    sc = link_wrap.parent(),
                    set_min_height = trx_addons_apply_filters('trx_addons_filter_set_min_height_on_switch_tabs', !0, sc),
                ...
                if (link_wrap.hasClass('sc_item_filters') && link.data('posts') !== undefined) {
                    ...
                    TRX_ADDONS_STORAGE.pagination_busy = !0;
                    jQuery.post(TRX_ADDONS_STORAGE.ajax_url, {
        ...
        function trx_addons_replace_posts(posts, posts_new) {
            if (posts.hasClass('masonry_wrap')) {
                ...
                if (posts.find('>.slider_container').length > 0) {
                    ...
                    posts.toggleClass('trx_addons_columns_wrap', !0)
                } else if (posts.find('>[class*="column-"]').length > 0) {
                    posts.toggleClass('columns_wrap', !0)
                }
            }
        ...
        jQuery('.sc_post_details_popup:not(.inited)').addClass('inited').on('click', 'a', function(e) {
            trx_addons_show_post_details(jQuery(this).parents('[data-post_id]'), !0);
            e.preventDefault();
            return !1
        });
        if (jQuery('.sc_post_details_popup.inited').length > 0) {
            jQuery('body:not(.sc_post_details_popup_inited)').addClass('sc_post_details_popup_inited').on('click', '#trx_addons_post_details_popup_overlay, .trx_addons_post_details_popup_close', function(e) {
                ...
                if (cur_idx == -1) return;
                post_item = jQuery(this).hasClass('trx_addons_post_details_popup_prev') ? (cur_idx > 0 ? posts_items.eq(cur_idx - 1) : !1) : (cur_idx < posts_items.length - 1 ? posts_items.eq(cur_idx + 1) : !1);
                if (!post_item || post_item.length === 0) return;
                popup.fadeOut();
                trx_addons_show_post_details(post_item, !1)
            })
        }
...
(function() {
    ...
    if (typeof TRX_ADDONS_STORAGE != 'undefined' && TRX_ADDONS_STORAGE.popup_engine != 'none') {
        $document.on('action.init_hidden_elements', function(e, cont) {
            ...
            if (trx_addons_apply_filters('trx_addons_filter_disable_elementor_lightbox', !0)) {
    ...
    $window.on('elementor/frontend/init', function() {
        if (typeof window.elementorFrontend !== 'undefined' && typeof window.elementorFrontend.hooks !== 'undefined') {
            if (elementorFrontend.isEditMode()) {
                var init_hidden_elements_immediately = !1,
                    init_hidden_elements_immediately_start = trx_addons_throttle(function() {
                        init_hidden_elements_immediately = !0;
    ...
    $document.on('action.prepare_popup_elements', function(e, cont, mfp) {
        ...
        items.each(function(idx) {
            ...
            if (block || !mfp) {
                trx_addons_elementor_animate_item($self, idx, items.length, !1)
            }
        });
        cont.data({
    ...
    window.trx_addons_elementor_prepare_animate_items = function(force) {
        ...
        jQuery('[class*="animation_type_"]:not(.animation_type_block)' + (!force ? ':not(.animated-separate)' : '')).each(function() {
            var sc = jQuery(this),
                ...
                section = sc.hasClass('elementor-section') ? sc : (sc.hasClass('elementor-container') || sc.hasClass('elementor-row') ? sc.parents('.elementor-section') : !1),
    ...
    function trx_addons_elementor_animate_item(item, idx, total, force) {
        ...
        if (force) {
            ...
            if (!1 && !item.hasClass(item_animation)) {
    ...
    function trx_addons_elementor_add_bg_text_in_row(row) {
        ...
        if (data.bg_text) {
            ...
            if (marquee_speed > 0 && (delimiter_icon || delimiter_image)) {
                chars += '<span class="trx_addons_bg_text_char' + ' trx_addons_bg_text_delimiter' + (!delimiter_image && delimiter_icon ? ' trx_addons_bg_text_delimiter_icon ' + delimiter_icon : ' trx_addons_bg_text_delimiter_image') + (data.bg_text_delimiter_rotation > 0 ? ' trx_addons_bg_text_delimiter_rotation' : '') + '">' + (delimiter_image ? (delimiter_svg ? delimiter_svg : '<img src="' + delimiter_image + '" />') : '') + '</span>'
            }
            ...
            if (marquee_speed > 0 && cid === '') {
                var marquee_wrap = row_cont.find('.trx_addons_marquee_wrap').eq(0),
                    marquee_chars = Math.min(100, data.bg_text_effect == 'none' ? trx_addons_clear_tags(data.bg_text).length + (delimiter_icon || delimiter_image ? 1 : 0) : marquee_wrap.find('.trx_addons_bg_text_char').length);
                setTimeout(function() {
                    trx_addons_elementor_marquee_bg_text(marquee_wrap, marquee_dir, marquee_speed, !0, data.bg_text_effect, data.bg_text_marquee_hover, data.bg_text_accelerate)
    ...
    function trx_addons_elementor_marquee_bg_text(marquee_wrap, marquee_dir, marquee_speed, start, effect, pause_on_hover, accelerate) {
                ...
                $self.data('tweenmax-object', TweenMax.to(elements.eq(idx), mw * time_per_pixel, {
                    ...
                    onComplete: function() {
                        if (idx == elements.length - 1) {
                            ...
                            setTimeout(function() {
                                trx_addons_elementor_marquee_bg_text(marquee_wrap, marquee_dir, marquee_speed, !1, effect, pause_on_hover, accelerate)
                            }, 1)
                        }
                    }
        ...
        if (accelerate) {
            var wheel_busy = !1,
                ...
                wheel_handler = function(e) {
                    ...
                    elements.eq(0).data('tweenmax-accelerate', TweenMax.to(wheel_accelerate, 2.0, {
                        ...
                        ease: Power4.easeOut,
                        onUpdate: function() {
                            var coef = wheel_accelerate.value == 1 ? 1 : (wheel_accelerate.value <= 8 ? wheel_accelerate.value : 16 - wheel_accelerate.value);
                            elements.each(function(idx) {
            ...
            TRX_ADDONS_STORAGE.bg_text_mousewheel_inited = !0;
...
(function() {
    ...
    function parallax_text_prepare($init_obj, settings) {
        if (!settings) {
            if (!edit_mode) {
                var params = $init_obj.data('parallax-params') || !1;
                if (params) {
                    settings = [];
        ...
        if ($inner_obj.length === 0) {
            ...
            if ($inner_obj.length > 0) {
                $inner_obj.each(function(idx) {
                    $inner_obj.eq(idx).html(settings[0].text == 'chars' ? parallax_text_wrap_chars($inner_obj.eq(idx).html(), !0) : parallax_text_wrap_words($inner_obj.eq(idx).html()))
                });
    ...
    window.trx_addons_parallax = function($target, init_type) {
        ...
        self.init = function() {
            if (!edit_mode) {
                if (init_type == 'layers') {
                    settings = $target.data('parallax-blocks') || !1;
                    if (settings) {
                        parallax_type = 'layers'
                    }
                } else {
                    var params = $target.data('parallax-params') || !1;
                    if (params) {
                        settings = [];
                        settings.push(params);
            ...
            if (parallax_type.indexOf('blocks') >= 0) {
                ...
                settings[0].hscroller = settings[0].hsection.length ? settings[0].hsection.parents('.sc_hscroll_scroller') : !1;
        ...
        self.create_layers = function() {
            ...
            jQuery.each(settings, function(index, block) {
                var image = block.image.url,
                    ...
                    bg_parallax = block.bg_parallax && type == 'scroll' && anim_prop == 'background' ? block.bg_parallax : !1,
                    $layout = null;
                if (bg_parallax) {
                    bg_parallax_present = !0
                }
                if ('' !== image || 'none' !== type) {
                    var layout_init = {
                        'z-index': z_index
                    ...
                    if ('scroll' === type) {
                        ...
                        layout_data.hscroller = layout_data.hsection.length ? layout_data.hsection.parents('.sc_hscroll_scroller') : !1;
...
jQuery(document).on('action.ready_trx_addons', function() {
    "use strict";
    var USE_OBSERVERS = trx_addons_apply_filters('trx_addons_filter_use_observers_to_fix_rows', !0) && typeof IntersectionObserver != 'undefined';
    var $window = jQuery(window),
        $document = jQuery(document),
        $body = jQuery('body');
    ...
    function trx_addons_cpt_layouts_fix_rows(args) {
        ...
        rows.each(function(idx) {
            ...
            var row_unfixed_placeholder = row.hasClass('sc_layouts_row_hide_unfixed') ? row.prev() : !1;
            var delay = trx_addons_cpt_layouts_fix_rows_delay(row);
            var animation_off_timeout = trx_addons_cpt_layouts_fix_rows_off_timeout(delay);
...
(function() {
    ...
    function trx_addons_init_sliders(e, container) {
        ...
        if (window.Swiper) {
            ...
            container.find('.sc_slider_controls:not(.inited)').each(function() {
                ...
                var s = typeof TRX_ADDONS_STORAGE.swipers != 'undefined' && typeof TRX_ADDONS_STORAGE.swipers[slider_id] != 'undefined' ? TRX_ADDONS_STORAGE.swipers[slider_id] : !1,
            ...
            container.find('.slider_swiper:not(.inited)').each(function() {
                ...
                slider.find('img').each(function() {
                    var $self = jQuery(this);
                    if (!$self.get(0).complete && $self.attr('loading') != 'lazy') loaded = !1
                });
                ...
                TRX_ADDONS_STORAGE.swipers[id] = new Swiper('.' + id, trx_addons_apply_filters('trx_addons_filter_slider_init_args', {
                    ...
                    pagination: {
                        ...
                        clickable: slider.hasClass('slider_pagination') ? '#' + cont_id + ' .slider_pagination_wrap' : !1,
                    ...
                    autoplay: slider.hasClass('slider_noautoplay') || (typeof slider.data('autoplay') !== 'undefined' && slider.data('autoplay') == 0) ? !1 : {
                        delay: interval,
    ...
    $document.on('action.ready_trx_addons', function(e) {
        ...
        if (trx_addons_apply_filters('trx_addons_filter_add_effect_to_swiper', !0, 'swap')) {
            ...
            if (typeof Swiper.prototype.modules != 'undefined' && typeof Swiper.prototype.modules["effect-fade"] != 'undefined') {
                Swiper.__proto__.Swap = {
                    ...
                    setTransition: function setTransition(duration) {
                        effectSwapModules.setTransition(this, duration, !1)
                    }
                };
                ...
                const EffectSwap = function(_ref) {
                    ...
                    const setTransition = duration => {
                        effectSwapModules.setTransition(swiper, duration, !0)
                    };
                    effectInit({
                        effect: 'swap',
                        swiper,
...
jQuery(document).on('action.ready_trx_addons', function() {
    ...
    if (!$body.hasClass('added_to_cart_inited')) {
        ...
        if ($sc_cart.length > 0) {
            ...
            $document.on('action.prepare_popup_elements', function(e, panel) {
                if (panel.hasClass('sc_layouts_cart_panel')) {
                    $sc_cart.find('[data-panel-id="' + panel.attr('id') + '"]').each(function() {
                        ...
                        if ($cart.is(':visible')) {
                            $cart.toggleClass('sc_layouts_cart_opened', !0)
                        }
                    })
                }
            });
            ...
            if (trx_addons_apply_filters('trx_addons_filter_sc_layouts_cart_button_hide_on_scroll', !0)) {
                $document.on('action.scroll_trx_addons', function() {
            ...
            jQuery(selector).show().each(function() {
                ...
                function trx_addons_before_show_menu(menu_item) {
                    ...
                    if (!in_columns) {
                        ...
                        if (animation_in != 'none') {
                            animated = trx_addons_apply_filters('trx_addons_filter_menu_animation_in', !1, menu_item, animation_in, animation_out);
                            if (!animated) {
                ...
                function trx_addons_before_hide_menu(menu_item) {
                    ...
                    if (animation_out != 'none') {
                        animated = trx_addons_apply_filters('trx_addons_filter_menu_animation_out', !1, menu_item, animation_in, animation_out);
                        if (!animated) {
    ...
    function trx_addons_menu_collapse() {
        ...
        jQuery('.sc_layouts_menu:not(.sc_layouts_menu_no_collapse):not(.sc_layouts_menu_dir_vertical)').each(function() {
            ...
            function check_menu_wrapper(item) {
                var allow_any_wrapper = trx_addons_apply_filters('trx_addons_filter_menu_collapse_allow_any_wrapper', !0);

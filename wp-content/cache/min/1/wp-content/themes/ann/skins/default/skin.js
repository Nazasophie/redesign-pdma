(function() {
    ...
    if (document.getElementById("bannerSVG") !== null) {
        var o, s, c, l, _, g, h, u, d, m, f = Math.sin,
            p = Math.cos,
            w = Math.round,
            v = Math.sqrt,
            y = Math.max;
        var resizeHandler = function() {
            ...
            g = [], o.setAttribute("viewBox", "0 0 ".concat(window.innerWidth, " ").concat(y(100, window.innerHeight))), m = c.length;
            for (var t = (o.viewBox.baseVal.height - 10) / m, i = 0; i < m; i++) {
                var a = document.createElementNS(o.namespaceURI, "text");
                a.setAttribute("x", 5), a.setAttribute("y", i * t + 5), a.style.fontSize = "".concat(.95 * t, "px"), a.style.fontFamily = "monospace", a.style.dominantBaseline = "hanging", a.style.whiteSpace = "pre", o.appendChild(a), _[i] = a
            }
    ...
    jQuery(document).on('action.ready_ann', function() {
        ...
        function mc4wpGO(form) {
            jQuery(form).each(function() {
                ...
                var $i_agree = form.find('input[type="checkbox"][name="i_agree_privacy_policy"]:not(.inited)' + ',input[type="checkbox"][name="gdpr_terms"]:not(.inited)' + ',input[type="checkbox"][name="wpgdprc"]:not(.inited)' + ',input[type="checkbox"][name="AGREE_TO_TERMS"]:not(.inited)');
